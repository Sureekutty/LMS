...
public class MemDetailspdf {
	...
	public static void getPDF(String MemAccNO,String header,String number) throws Exception {
		...
		outputStream = new FileOutputStream(new File("MemDetailspdf.pdf"));
...
String sqlquery="speccs.SP_Prints 'MEMETAILS','"+MemAccNO+"','','',''";
     ...
     ps = connection.prepareStatement(sqlquery);
       ...
       if(rs3.next()) {
    	   Employee=rs3.getString("MemAccNo")+"-"+rs3.getString("MemEmpCode")+"-"+rs3.getString("MemName");
	   ...
	   table1.addCell(new Phrase("RetirementDate ", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 9)));
	   table1.addCell(new Phrase(":"+RetiredDate, FontFactory.getFont(FontFactory.HELVETICA, 9)));
	   ...
	   p1.setAlignment(Element.ALIGN_CENTER);
		...
		table2.addCell(new Phrase("", FontFactory.getFont(FontFactory.HELVETICA, 9)));
		   ...
		   Paragraph  p3 = new Paragraph("Nominee Details",FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE, 10, com.itextpdf.text.Font.UNDERLINE, new BaseColor(0, 0, 0)));
