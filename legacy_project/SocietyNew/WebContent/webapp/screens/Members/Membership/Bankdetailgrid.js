...
var dsOption = {
	...
	var colsOption = [ 
			    {id : 'BankAccNo',header : "BankAccNo",editor:{type:"text"},width : 250},
			    {id : 'Ifsccode',header : "IFSC Code",editor:{type:"text"},width : 190},
			    {id : 'Bankname',header : "Bank Name",editor:{type:"text"},width : 240}, 
			    {id : 'Bankplace',header : "Bank Place",editor:{type:"text"},width : 240},
			    {id:'DELETE',header:"Option",width:80,renderer:show_delBank}
			    ];
