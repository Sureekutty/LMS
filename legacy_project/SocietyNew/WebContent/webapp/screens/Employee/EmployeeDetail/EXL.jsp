...
<!-- Modal -->
 ...
 String query1 = "SELECT la.TransactionDate,la.P_I,la.Amount,la.Modeofpay,la.ClosingBal FROM speccs.LoanTransactions la,speccs.Loans l WHERE la.LoanAccNo=l.LoanAccNo AND l.LoanType='EXL' AND l.MemAccNo= (Select MemAccNo from speccs.Members where MemEmpCode='"+empCode+"') ORDER BY la.TransactionDate DESC";
