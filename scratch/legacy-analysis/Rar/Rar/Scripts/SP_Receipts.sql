IF OBJECT_ID ('speccs.SP_Receipts') IS NOT NULL
	DROP PROCEDURE speccs.SP_Receipts
GO

CREATE  PROCEDURE speccs.SP_Receipts
@Option  		VARCHAR (20),
 ...
 */
	...
	SELECT @ClosingBalance=0, @txMonth=MAX(TransactionMonth)	FROM speccs.ProcessMonth WHERE ProcessFlag='N'
...
IF(@@ERROR!=0)
BEGIN
	RAISERROR 99999 "Error while inserting data in Receipts :SP_Receipts "
