...
SELECT @BankBalance=BankBalance  FROM speccs.BankBalance123 
    ...
    FROM speccs.BankTransactions123
    ...
    BEGIN
      ...
      DECLARE @Bankbalnce1 FLOAT,@BAmt FLOAT,@BNo VARCHAR(14)
             ...
             SELECT TOP 1 @Bankbalnce1= BankBalance FROM speccs.BankTransactions123 WHERE TransactionDate>@BTransactiondate  ORDER BY TransactionDate ASC, RegTime ASC
             SELECT  TOP 1 @BAmt= Amount FROM  speccs.BankTransactions123 WHERE TransactionDate>@BTransactiondate  ORDER BY TransactionDate ASC, RegTime ASC
             SELECT  TOP 1 @BNo= ReceiptNo from speccs.BankTransactions123 WHERE TransactionDate>@BTransactiondate  ORDER BY TransactionDate ASC, RegTime ASC
      ...
      /*  IF (LEFT(@BNo,1) = 'P')
              ...
              UPDATE speccs.BankBalance123
				SET BankBalance=@BankBalance+@BAmount WHERE BankName='SBI'
				INSERT INTO speccs.BankTransactions123 (ReceiptNo,TransactionDate,Amount,BankName,BankBalance,PurCode,RefNo,RegTime,UserId)
      ...
      DECLARE @CurrentReceiptNo VARCHAR(14), 
            ...
            UPDATE speccs.BankTransactions123
