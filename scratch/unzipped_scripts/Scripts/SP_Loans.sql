IF OBJECT_ID ('speccs.SP_Loans') IS NOT NULL
	DROP PROCEDURE speccs.SP_Loans
GO

CREATE  PROCEDURE speccs.SP_Loans
...
@surety1 		   	VARCHAR(8)= NULL,
@surety2 		   	VARCHAR(8)= NULL,
@surety3 		   	VARCHAR(8)= NULL,
...
*/
	...
	BEGIN
		...
		LoanSanctionAmount=@loansancamt,InterestRate=@Interestrate,Surety1=@surety1,Surety2=@surety2,Surety3=@surety3,
...
InterestRate=@Interestrate,Surety1=@surety1,Surety2=@surety2,Surety3=@surety3,
Loanappdate=@loansancdate,Remarks=@Remarks,UserId=@userid,RegTime=GETDATE() WHERE LoanAccNo=@Loanaccno
